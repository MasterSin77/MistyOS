...
const batch = {
  name: "stage-c-batch2-morphology",
  experiments: [
    {
      parameter: "trailDistance",
      baseline: [16, 34],
      cases: [
        { label: "low", value: [10, 20], query: "expTrailDistanceMin=10&expTrailDistanceMax=20" },
        { label: "current", value: [16, 34], query: "expTrailDistanceMin=16&expTrailDistanceMax=34" },
        { label: "high", value: [26, 48], query: "expTrailDistanceMin=26&expTrailDistanceMax=48" }
      ]
    },
    {
      parameter: "trailDropSize",
      baseline: [0.35, 0.6],
      cases: [
        { label: "low", value: [0.2, 0.4], query: "expTrailDropSizeMin=0.20&expTrailDropSizeMax=0.40" },
        { label: "current", value: [0.35, 0.6], query: "expTrailDropSizeMin=0.35&expTrailDropSizeMax=0.60" },
        { label: "high", value: [0.5, 0.85], query: "expTrailDropSizeMin=0.50&expTrailDropSizeMax=0.85" }
      ]
    },
    {
      parameter: "trailDropDensity",
      baseline: 0.2,
      cases: [
        { label: "low", value: 0.12, query: "expTrailDropDensity=0.12" },
        { label: "current", value: 0.2, query: "expTrailDropDensity=0.20" },
        { label: "high", value: 0.32, query: "expTrailDropDensity=0.32" }
      ]
    },
    {
      parameter: "trailSpread",
      baseline: 0.52,
      cases: [
        { label: "low", value: 0.3, query: "expTrailSpread=0.30" },
        { label: "current", value: 0.52, query: "expTrailSpread=0.52" },
        { label: "high", value: 0.75, query: "expTrailSpread=0.75" }
      ]
    },
    {
      parameter: "colliderSize",
      baseline: 1,
      cases: [
        { label: "low", value: 0.7, query: "expColliderSize=0.70" },
        { label: "current", value: 1, query: "expColliderSize=1.00" },
        { label: "high", value: 1.2, query: "expColliderSize=1.20" }
      ]
    }
  ]
};
