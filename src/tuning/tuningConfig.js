...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    controls: [
      ...
      { path: 'links.largeRunnerInfluence', label: 'Large Runner Influence', min: 0.2, max: 2, step: 0.02, tooltip: 'Linked control driving both head and trail influence.' },
    ],
    toggles: [
  ...
  },
  {
    ...
    selects: [
      ...
      },
      {
        path: 'debug.viewMode',
        label: 'View Mode',
        tooltip: 'Choose combined, renderer-only, fog-only, split compare, or surface-debug views for wetness/trail/runner/composite channels.',
        options: ['combined', 'renderer-only', 'fog-only', 'split-compare', 'debug-wetness', 'debug-trail', 'debug-runner', 'debug-combined-surface'],
      },
    ],
  },
]
